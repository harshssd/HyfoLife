...
function HabitCard({ title, emoji, streakDays, goalPct, onQuickLog, onOpen, type }: Props) {
    ...
    <Pressable onPressIn={onPressIn} onPressOut={onPressOut} onPress={onQuickLog}>
      ...
      >
        <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
          <Text style={{ fontSize: theme.font.h2, color: theme.colors.text }}>
            {emoji} {title}
          </Text>
            ...
            >
              <Animated.View
                style={{
                  ...
                  height: 6,
                  borderRadius: 4,
                  backgroundColor: reached ? theme.colors.success : theme.colors.accent,
                }}
              />
            </View>
          </View>
